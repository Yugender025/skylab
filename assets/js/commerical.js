...
const serviceData = {
  office: {
    ...
    subtitle:
      "Sophisticated workspaces that enhance productivity and inspire innovation",
  },
  commercial: {
    title: "Commercial Interiors",
    subtitle:
      "Dynamic spaces that reflect your brand identity and corporate values",
  },
  retail: {
    title: "Luxury Retail Spaces",
    subtitle:
      "Immersive shopping experiences that captivate customers and drive sales",
  },
  hospitality: {
    title: "Hospitality & Dining",
    subtitle:
      "Memorable environments that create exceptional guest experiences",
  },
  corporate: {
    title: "Corporate Transformation",
    subtitle: "Complete renovations and premium fit-outs for modern businesses",
  },
};
